************************************************************************
*                                                                      *
      SUBROUTINE MCP (NAME,IK,NTESTG,INPCI)
*                                                                      *
...
c          if(ichkq1(JA,JB).eq.0) COMP=.FALSE.
...
Ctest
      do j=1,NVEC
          print *, 'myid=',myid,' Rotated eigenvector: '
          do i=1,ncf
              WRITE(*,999) i, EVEC(I+(J-1)*NCF)
          enddo
      enddo
