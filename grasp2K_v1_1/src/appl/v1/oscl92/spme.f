...
*
            DO 1 II = 1,N
               TB(II) = PF(II,I)*QF(II,J)+QF(II,I)*PF(II,J)
               TC(II) = PF(II,I)*QF(II,J)-QF(II,I)*PF(II,J)
               TD(II) = PF(II,I)*PF(II,J)+QF(II,I)*QF(II,J)
    1       CONTINUE
            LP = LK+1
            LM = LK-1
*
...
*
            TA(1) = 0.0D 00
            DO 9 II = 2,MTP
               TA(II) =  ( PF(II,I)*QF(II,J)+QF(II,I)*PF(II,J) )
     :                  *BJ(II,2)*RP(II)
    9       CONTINUE
            CALL QUAD (VALUE)
