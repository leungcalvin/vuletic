...
*=======================================================================
     ...
     &                     startdir, permdir, tmpdir, 'MCPMPIVU')
...
*   
      ...
      CALL FACTT
      CALL MCP(NAME(1),startdir,1,NTESTG,INPCI) 
...
*   
      ...
      iii = len_trim(tmpdir)   
      call sys_chdir(trim(tmpdir)//'/'//idstring,iii+4,ierr)
      CALL MCP(NAME(2),startdir,2,NTESTG,INPCI) 
...
*R      ENDDO
        ...
        if (myid .eq. 0) then
          PRINT *
          PRINT *, ' BIOTRA: Execution complete.'
        endif
*=======================================================================
