...
!-----------------------------------------------
      ...
      real(DOUBLE), dimension(1:100)  :: weights, weights2
      integer, dimension(:), pointer  :: ithresh 
      character(LEN=64), dimension(1:Vectors_number) :: string_CSF
!-----------------------------------------------
            ...
            do  i = 1,asf_set_LS%csf_set_LS%nocsf
               ...
               do  j = 1,99
                  if (wa*wa > weights2(j)) then
                     weights2(j+1:100) = weights2(j:99)
                     weights(j+1:100)  = weights(j:99)
                     weights(j)         = wa
                     weights2(j)        = wa*wa
                     iw(j+1:100)       = iw(j:99)
...
!-----------------------------------------------
      ...
      CHARACTER(LEN=64), INTENT(OUT) :: string_CSF
!-----------------------------------------------
!   L o c a l   V a r i a b l e s
!-----------------------------------------------
      integer                                 :: I, j, counter
      ...
      character(len=3), dimension(15)         :: COUPLE
      character(len=3), dimension(8)          :: ELC
      CHARACTER(LEN=2)                        :: String
      CHARACTER(LEN=64)                       :: string_CSF_PACK
...
!***********************************************************************
!                                                                      *
      SUBROUTINE prCSFjj(stream,csf_number)
!                                                                      *
...
!
      if (stream == -1) then
         write(*,1) csf_number,(String_NL(j),                    &
