************************************************************************
*                                                                      *
      SUBROUTINE BRINT1 (IA,IB,IC,ID,NU,TEGRAL)
*                                                                      *
...
*
         IF (INDEX .GT. INDTP1(NTPI(1))) THEN
*
...
*
            TEGRAL = BRINTF (1,IA,IB,IC,ID,NU)
*
...
*
*
            IF (NTPI(1) .GT. NDTPA(1)) THEN
               NEWSIZ = NDTPA(1)+NDTPA(1)/2
               CALL RALLOC (PINDT1,NDTPA(1),NEWSIZ,4)
               CALL RALLOC (PVALT1,NDTPA(1),NEWSIZ,8)
               NDTPA(1)= NEWSIZ
            ENDIF
            DO 2 I = NTPI(1),LOC+2,-1
               INDTP1(I) = INDTP1(I-1)
               VALTP1(I) = VALTP1(I-1)
    2       CONTINUE
*
...
*
         CALL ALLOC (PINDT1,NDTPA(1),4)
         CALL ALLOC (PVALT1,NDTPA(1),8)
         INDTP1(1) = INDEX
         VALTP1(1) = TEGRAL
*
      ENDIF
